...
# 会員のマスターデータ
users = [
  { login_id: "seiya", email: "stn230501@gmail.com", name: "鈴木晴也", name_kana: "スズキセイヤ", birthday: Date.new(1999, 12, 9), phone: "08035535646", password: "Seiya01!?", password_confirmation: "Seiya01!?", status: 1, introducer_id: 99999, left_or_right: nil, admin_flg: 1, gender_id: 1, online_flg: 9, grade_id: 4, created_at: Time.current, updated_at: nil },
...
user_addresses = [
  { user_id: 1, zip_str3: 252, zip_str4: 0o136, ken: "神奈川県", city: "相模原市緑区上九沢124-5", other_address: nil },
  { user_id: 2, zip_str3: 160, zip_str4: 0o023, ken: "東京都", city: "新宿区西新宿3丁目3-13", other_address: nil }
]

user_banks = [
  { user_id: 1, bank_name: "三菱UFJ銀行", account_type: 1, branch_name: "橋本支店", branch_number: "012", account_number_hash: "********", account_number_tail: "*******123", account_holder: "NISHINO MICHIYA" },
  { user_id: 2, bank_name: "三菱UFJ銀行", account_type: 1, branch_name: "橋本支店", branch_number: "012", account_number_hash: "********", account_number_tail: "*******123", account_holder: "NISHINO MICHIYA" },
]
