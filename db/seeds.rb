...
# 会員のマスターデータ
users = [
  { id: 1, login_id: "michiya0509", email: "nishino.michiya0509@gmail.com", name: "西野倫也", name_kana: "ニシノミチヤ", birthday: Date.new(1999, 5, 9),
    phone: "09083675290", password: "MiChiYa0509!?", password_confirmation: "MiChiYa0509!?", status: 1, introducer_id: 99999, left_or_right: nil, admin_flg: 1, gender_id: 1, online_flg: 9, grade_id: 2, created_at: Time.current, updated_at: nil },
  { id: 2, login_id: "seiya", email: "stn230501@gmail.com", name: "鈴木晴也", name_kana: "スズキセイヤ", birthday: Date.new(1999, 12, 9), phone: "08035535646",
    password: "Seiya01!?", password_confirmation: "Seiya01!?", status: 1, introducer_id: 99999, left_or_right: nil, admin_flg: 1, gender_id: 1, online_flg: 9, grade_id: 3, created_at: Time.current, updated_at: nil },
]
...
user_banks = [
  { id: 1, user_id: 1, bank_name: "三菱UFJ銀行", account_type: "普通預金", branch_name: "橋本支店", branch_number: "012", account_number_hash: "********",
    account_number_tail: "*******123", account_holder: "NISHINO MICHIYA" },
]
